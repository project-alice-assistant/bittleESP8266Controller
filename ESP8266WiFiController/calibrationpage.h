...
<div class="content">
    <div class="explanation">
        <h3>Calibrating is vital for your robot to correctly stand and walk</h3>
    ...
    <h2>Offset amount</h2>
    <div class="radio">
        <label for="offsetAmountSetter" id="offsetAmount">1</label><input id="offsetAmountSetter" type="range" min="1" max="10" step="1" value="1" name="offsetAmount" onchange="setOffset(this.value)"/>
    </div>
    <h2>Head (0)</h2>
    <div class="card">
